...
<div class="col-md-10">
<a href="mailto:toluwaseolamide6@gmail.com" style="color:#000000">sunnygkp10@gmail.com</a><br /><br />
...
<a href="light/index2.php" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM001211.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
     <div class="col-md-5">
		<a href="http://evlyntoc.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="view profile">Toluwase Olamide christianah</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">09053685212</h4>
		<h4 style="font-family:'typo' ">toluwaseolamide6@gmail.com</h4>
		<h4 style="font-family:'typo' ">EVLYNTOC</h4></div></div>
		</p>
      </div>
